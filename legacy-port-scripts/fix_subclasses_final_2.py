...
def fix_subclasses(file_path):
    ...
    # Fix onViewBindingCreated signature for subclasses
    content = content.replace("override fun onViewBindingCreated(binding: com.nyora.hasan72341.databinding.FragmentMangaListBinding, savedInstanceState: Bundle?)", "override fun onViewBindingCreated(binding: androidx.viewbinding.ViewBinding, savedInstanceState: Bundle?)")
